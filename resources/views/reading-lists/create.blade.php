...
@section('title', 'Create Reading List')

@section('content')
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Create Reading List</h1>
        <p class="mt-2 text-gray-600 dark:text-gray-400">Organize your bookmarks into a new collection</p>
    </div>

    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        <form method="POST" action="{{ route('reading-lists.store') }}">
            @csrf
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    placeholder="e.g., Must Read Articles, Learning Resources"
                    required
                    autofocus
                >
                @error('name')
            ...
            <div class="mb-6">
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Help others understand what this list is about
                </p>
            </div>
