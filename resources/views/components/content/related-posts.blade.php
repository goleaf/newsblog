@props(['posts', 'title' => 'More like this', 'limit' => 4])
                ...
                <article class="group">
                    ...
                    >
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <a 
                                href="{{ route('post.show', $post->slug) }}" 
                                class="inline-flex items-center gap-1 text-xs font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors mt-1"
                            >
                                <span>Read more</span>
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
