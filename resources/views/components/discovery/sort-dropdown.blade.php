...
@php
$sortOptions = [
    'newest' => ['label' => 'Newest First', 'icon' => 'M3 4h13M3 8h9m-9 4h6m4 0l4-4m0 0l4 4m-4-4v12'],
    ...
    'relevant' => ['label' => 'Most Relevant', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2'],
];

$currentOption = $sortOptions[$currentSort] ?? $sortOptions['newest'];
@endphp
    ...
    >
        <div class="py-1" role="none">
            @foreach($sortOptions as $value => $option)
                <a 
                    href="{{ route('search', array_merge(['q' => $query, 'sort' => $value], $filters)) }}"
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400">
                @switch($currentSort)
                    ...
                    @case('popular')
                        ...
                        @break
                    @case('trending')
                        Showing currently trending articles
                        @break
                    @case('relevant')
                        Showing most relevant matches to your search
                        @break
                    @default
