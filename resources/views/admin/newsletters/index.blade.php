                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $stats['verified'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                @forelse($newsletters as $newsletter)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($newsletter->status === 'subscribed' && $newsletter->verified_at)
                                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">
                                                    Verified
                                                </span>
                                            @elseif($newsletter->status === 'pending')
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                            {{ $newsletter->verified_at ? $newsletter->verified_at->format('M d, Y H:i') : '-' }}
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
