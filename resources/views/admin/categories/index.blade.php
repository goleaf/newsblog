...
<div class="px-4 sm:px-0">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">Manage your content categories</p>
        </div>
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white dark:bg-gray-900 dark:divide-gray-700">
                            @forelse($categories as $category)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 dark:text-gray-300">{{ $category->parent->name ?? '-' }}</td>
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 dark:text-gray-300">{{ $category->posts_count }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-500 dark:text-gray-300 sm:pl-6 text-center">No categories found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
