...
class KeyboardNavigationTest extends TestCase
{
    ...
    #[Test]
    public function all_interactive_elements_are_keyboard_accessible(): void
    {
        $response = $this->get('/');
    ...
    #[Test]
    public function navigation_links_are_keyboard_accessible(): void
    {
        $response = $this->get('/');
    ...
    #[Test]
    public function search_input_is_keyboard_accessible(): void
    {
        $response = $this->get('/');
    ...
    #[Test]
    public function dropdown_menus_support_keyboard_navigation(): void
    {
        $response = $this->get('/');
    ...
    #[Test]
    public function modals_trap_focus_when_open(): void
    {
    ...
    #[Test]
    public function escape_key_closes_modals_and_dropdowns(): void
    {
        $response = $this->get(route('post.show', $this->post->slug));
    ...
    #[Test]
    public function tab_order_follows_logical_flow(): void
    {
        $response = $this->get('/');
    ...
    #[Test]
    public function form_inputs_are_keyboard_accessible(): void
    {
    ...
    #[Test]
    public function buttons_can_be_activated_with_enter_and_space(): void
    {
        $response = $this->get(route('post.show', $this->post->slug));
    ...
    #[Test]
    public function skip_to_main_content_link_is_first_focusable_element(): void
    {
        $response = $this->get('/');
    ...
    #[Test]
    public function search_autocomplete_supports_arrow_key_navigation(): void
    {
        $response = $this->get('/');
    ...
    #[Test]
    public function category_menu_supports_keyboard_navigation(): void
    {
        $response = $this->get('/');
    ...
    #[Test]
    public function bookmark_button_is_keyboard_accessible(): void
    {
        $response = $this->actingAs($this->user)
            ->get(route('post.show', $this->post->slug));
    ...
    #[Test]
    public function reaction_buttons_are_keyboard_accessible(): void
    {
        $response = $this->actingAs($this->user)
            ->get(route('post.show', $this->post->slug));
    ...
    #[Test]
    public function comment_form_is_keyboard_accessible(): void
    {
        $response = $this->actingAs($this->user)
            ->get(route('post.show', $this->post->slug));
    ...
    #[Test]
    public function mobile_menu_is_keyboard_accessible(): void
    {
        $response = $this->get('/');
    ...
    #[Test]
    public function pagination_links_are_keyboard_accessible(): void
    {
    ...
    #[Test]
    public function filter_controls_are_keyboard_accessible(): void
    {
    ...
    #[Test]
    public function all_links_have_visible_focus_indicators(): void
    {
        $response = $this->get('/');
    ...
    #[Test]
    public function keyboard_shortcuts_are_documented(): void
    {
        $response = $this->get('/');
